...
$INPUT ID DV MDV OPRED D_EPS1 TIME AMT WGT APGR FA1 FA2 D_ETA1
       D_ETA2 OETA1 OETA2 D_EPSETA1_1 D_EPSETA1_2
$DATA pheno_linear_linbase.dta IGNORE=@ IGNORE(MDV.NEN.0)
$PRED
...
$OMEGA  DIAGONAL(2)
 ...
 0.031128  ;        IVV
$SIGMA  0.013241
$ESTIMATION METHOD=COND INTERACTION MAXEVALS=9999999 PRINT=1
