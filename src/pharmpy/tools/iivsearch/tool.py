...
class RankingOptions:
    ...
    E: tuple[float | str, float | str] | None
...
def create_workflow(
    ...
    correlation_algorithm: Literal[tuple(IIV_CORRELATION_ALGORITHMS)] | None = None,
    E_p: float | str | None = None,
    E_q: float | str | None = None,
