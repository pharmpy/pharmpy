...
tab = NONMEMTableFile("/home/rikard/testing/vpcmix/vpc_dir65/m1/vpc_original.phm")

df = tab.tables[0].data_frame
df = df.set_index(['ID', 'SUBPOP'])
pmix = df[['PMIX']]

simtab = NONMEMTableFile("/home/rikard/testing/vpcmix/vpc_dir65/m1/vpc_simulation.1.phm")
