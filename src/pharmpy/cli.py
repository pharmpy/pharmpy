...
parser_definition = [
    {'data': {'subs': [
        ...
        {'append': {'help': 'Append column to dataset',
                    'parents': [args_model_or_data_input, args_output],
                    'func': data_append,
                    'args': [{'name': 'expression'}]}},
        {'resample': {'help': 'Resample dataset',
        ...
        {'anonymize': {'help': 'Anonyize dataset by and renumber a specific data column',
