...
def parse_estimation_steps(
    control_stream, random_variables, dependent_variables
) -> EstimationSteps:
    steps = []
    ...
    for table in table_records:
        ...
        if etaderivs:
            ...
            etaderiv_names = [
                ...
                for i in etaderivs
            ]  # FIXME : Overwrites each of the previous ones??
    ...
    # TODO : Add derivatives from verbatim code as well
    ...
    for record in records:
        ...
        try:
            meth = EstimationStep.create(
                ...
                solver_rtol=tol,
                solver_atol=atol,
                derivatives=set(etaderiv_names)
                .union(set(epsilonderivs_names))
                .union(verbatim_derivatives),
