...
@pytest.mark.parametrize(
    ...
    [
        (None, {'allometric_variable': 1}, TypeError, 'Invalid `allometric_variable`'),
        (None, {'reference_value': []}, TypeError, 'Invalid `reference_value`'),
        (None, {'parameters': 'CL'}, TypeError, 'Invalid `parameters`'),
        (None, {'initials': 0.1}, TypeError, 'Invalid `initials`'),
        (None, {'lower_bounds': 0.0001}, TypeError, 'Invalid `lower_bounds`'),
        (None, {'upper_bounds': 1000}, TypeError, 'Invalid `upper_bounds`'),
        (None, {'fixed': 1}, TypeError, 'Invalid `fixed`'),
        (
            ('nonmem', 'pheno.mod'),
        ...
        (
            ('nonmem', 'pheno.mod'),
            {'allometric_variable': 'WGT', 'parameters': ['K']},
            ValueError,
            'Invalid `parameters`',
        ),
        (
