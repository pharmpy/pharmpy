...
@pytest.mark.parametrize(
    ...
    [
        (None, {'column': 1}, TypeError, 'Invalid `column`'),
        (None, {'list_of_parameters': 'CL'}, TypeError, 'Invalid `list_of_parameters`'),
        ...
        (None, {'distribution': ['same-as-iiv']}, ValueError, 'Invalid `distribution`'),
        (None, {'distribution': 'same'}, ValueError, 'Invalid `distribution`'),
        (
            ('nonmem', 'pheno.mod'),
            {'column': 'OCC'},
            ValueError,
        ...
        (
            ('nonmem', 'pheno.mod'),
            {'column': 'APGR', 'list_of_parameters': ['K']},
            ValueError,
