...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            [create_joint_distribution],
            'IIV?([CL,VC,MAT],exp);COVARIANCE?(IIV,[CL,VC,MAT])',
            {},
            [partial(remove_iiv, to_remove=['ETA_CL']), partial(remove_iiv, to_remove=['ETA_VC'])],
            [6.59, 2.20],
        ),
        ...
        (
            ...
            'IIV([CL],exp);IIV?([VC,MAT,MDT],exp);COVARIANCE?(IIV,[CL,VC,MAT,MDT])',
            {},
            [
...
@pytest.mark.parametrize(
    ('search_space', 'candidate_features', 'p', 'k_p', 'q', 'k_q'),
    [
        ('ABSORPTION([FO,ZO])', 'ABSORPTION(FO)', 0, 0, 0, 0),
        ('ABSORPTION([FO,ZO])', 'ABSORPTION(ZO)', 0, 0, 0, 0),
        ('ABSORPTION([FO,SEQ-ZO-FO])', 'ABSORPTION(FO)', 1, 0, 0, 0),
        ('ABSORPTION([FO,SEQ-ZO-FO])', 'ABSORPTION(SEQ-ZO-FO)', 1, 1, 0, 0),
        ...
        ('ELIMINATION([FO,MM,MIX-FO-MM])', 'ELIMINATION(MM)', 1, 0, 0, 0),
        ('ELIMINATION([FO,MM,MIX-FO-MM])', 'ELIMINATION(MIX-FO-MM)', 1, 1, 0, 0),
        ('PERIPHERALS(0..2)', 'PERIPHERALS(0)', 2, 0, 0, 0),
        ('PERIPHERALS(0..2)', 'PERIPHERALS(1)', 2, 1, 0, 0),
        ('PERIPHERALS(0..2)', 'PERIPHERALS(2)', 2, 2, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],DEPOT)', 'TRANSITS(0)', 2, 0, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],DEPOT)', 'TRANSITS(1)', 2, 1, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],DEPOT)', 'TRANSITS(2)', 2, 1, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],NODEPOT)', 'TRANSITS(0,NODEPOT)', 0, 0, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],NODEPOT)', 'TRANSITS(1,NODEPOT)', 0, 0, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],NODEPOT)', 'TRANSITS(2,NODEPOT)', 0, 0, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],*)', 'TRANSITS(2)', 2, 1, 0, 0),
        ('ABSORPTION(FO);TRANSITS([0,1,2],*)', 'TRANSITS(2,NODEPOT)', 2, 0, 0, 0),
        ('LAGTIME(ON)', 'LAGTIME(ON)', 0, 0, 0, 0),
        ('LAGTIME([OFF,ON])', 'LAGTIME(OFF)', 1, 0, 0, 0),
        ('LAGTIME([OFF,ON])', 'LAGTIME(ON)', 1, 1, 0, 0),
        ...
        (
            'IIV?([CL,VC,MAT],exp);IOV?([CL,VC,MAT],exp)',
            'IIV([CL,VC],exp);IOV([CL,VC,MAT],exp)',
            6,
            5,
            0,
            0,
