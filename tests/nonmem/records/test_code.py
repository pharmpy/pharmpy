...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('$PK CL = PLOG(THETA(1))', S('CL'), sympy.Piecewise((sympy.log(2.8E-103), S('THETA(1)') < 2.8E-103), (sympy.log(S('THETA(1)')), True))),
        ('$PK CL = PLOG10(THETA(1))', S('CL'), sympy.Piecewise((sympy.log(2.8E-103, 10), S('THETA(1)') < 2.8E-103), (sympy.log(S('THETA(1)'), 10), True))),
        ...
        ('$PRED CL = PDZ(ETA(1))', S('CL'), sympy.Piecewise((1 / 2.8E-103, abs(S('ETA(1)')) < 2.8E-103), (1 / S('ETA(1)'), True))),
        ('$PRED CL = PZR(ETA(1))', S('CL'), sympy.Piecewise((2.8E-103, abs(S('ETA(1)')) < 2.8E-103), (S('ETA(1)'), True))),
        ('$PRED CL = PNP(ETA(1))', S('CL'), sympy.Piecewise((2.8E-103, S('ETA(1)') < 2.8E-103), (S('ETA(1)'), True))),
        ('$PRED CL = PHE(ETA(1))', S('CL'), sympy.Piecewise((100, S('ETA(1)') > 100), (S('ETA(1)'), True))),
        ('$PRED CL = PNG(ETA(1))', S('CL'), sympy.Piecewise((0, S('ETA(1)') < 0), (S('ETA(1)'), True))),
        ...
        ('$PRED CL = PSQRT(X)', S('CL'), sympy.Piecewise((0, S('X') < 0), (sympy.sqrt(S('X')), True))),
