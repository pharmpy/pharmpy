...
def test_get_raw_record_name(records):
    get_raw_record_name = records.get_raw_record_name
...
def test_get_canonical_record_name(records):
    get_canonical_record_name = records.get_canonical_record_name
...
def test_get_record_content(records):
    get_record_content = records.get_record_content
...
# def test_OptionDescription(records):
#     OptionDescription = records.option_description.OptionDescription
#
