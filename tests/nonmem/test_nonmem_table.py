...
def test_phi_table(pheno_phi):
    ...
    assert phi_table.goal_function == None
    ...
    assert np.allclose(df['ETC'][0], np.array([[2.48833E-02, -2.99920E-03], [-2.99920E-03, 7.15713E-03]]))
    assert np.allclose(df['ETC'][10], np.array([[2.85322E-02, -3.63402E-03], [-3.63402E-03, 1.17722E-02]]))
