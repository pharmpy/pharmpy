...
class TestFunctions(unittest.TestCase):
    def test_get_raw_record_name(self):
        from pysn.records.record import get_raw_record_name
    ...
    def test_get_canonical_record_name(self):
        from pysn.records.record import get_canonical_record_name
    ...
    def test_get_record_content(self):
        from pysn.records.record import get_record_content
