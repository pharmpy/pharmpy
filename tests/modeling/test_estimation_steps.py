...
$COVARIANCE UNCONDITIONAL PRINT=E PRECOND=1
$TABLE ID TIME DV AMT WGT APGR IPRED PRED RES TAD CWRES NPDE
 G011 G021 H011 D_EPSETA_1_1 D_EPSETA_1_2 RFORMAT="(1PE16.9,300(1PE24.16))" NOAPPEND NOPRINT ONEHEADER FILE=sdtab1\n"""
    )
...
$COVARIANCE UNCONDITIONAL PRINT=E PRECOND=1
$TABLE ID TIME DV AMT WGT APGR IPRED PRED RES TAD CWRES NPDE
 RFORMAT="(1PE16.9,300(1PE24.16))" NOAPPEND NOPRINT ONEHEADER FILE=sdtab1\n"""
    )
