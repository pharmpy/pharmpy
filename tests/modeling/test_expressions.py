...
@pytest.mark.parametrize(
    ...
    (
        ...
        ('pd', 'tmax', 'linear', ['B', 'SLOPE', 'T50', 'TMAX']),
        ('pd', 'tmax', 'emax', ['B', 'EC_50', 'E_MAX', 'T50', 'TMAX']),
        ('pd', 'tmax', 'sigmoid', ['N', 'B', 'EC_50', 'E_MAX', 'T50', 'TMAX']),
        ('kpd', None, 'linear', ['B', 'SLOPE', 'KE']),
        ('kpd', None, 'emax', ['B', 'EDK_50', 'E_MAX', 'KE']),
        ('kpd', None, 'sigmoid', ['N', 'B', 'EDK_50', 'E_MAX', 'KE']),
        ('kpd', 'tmax', 'linear', ['B', 'SLOPE', 'T50', 'KE', 'TMAX']),
        ('kpd', 'tmax', 'emax', ['B', 'EDK_50', 'E_MAX', 'T50', 'KE', 'TMAX']),
        ('kpd', 'tmax', 'sigmoid', ['N', 'B', 'EDK_50', 'E_MAX', 'T50', 'KE', 'TMAX']),
    ),
    ids=repr,
)
