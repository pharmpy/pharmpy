...
$MODEL COMPARTMENT=(TRANS2 DEFDOSE) COMPARTMENT=(DEPOT) COMPARTMENT=(CENTRAL) """
...
$INPUT ID TIME AMT WGT APGR DV FA1 FA2
$SUBROUTINE ADVAN5 TRANS1
$MODEL COMPARTMENT=(TRANSIT3 DEFDOSE) COMPARTMENT=(TRANSIT4) COMPARTMENT=(TRANS1) '''
        + '''COMPARTMENT=(TRANS2) COMPARTMENT=(DEPOT) COMPARTMENT=(CENTRAL) COMPARTMENT=(PERIPHERAL)
$PK
IF(AMT.GT.0) BTIME=TIME
TAD=TIME-BTIME
TVCL=THETA(1)*WGT
